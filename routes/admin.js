...
router.get('/service', async function (req, res) {
    ...
    res.render("service", { servicecars: servicecars, layout: false });
...
router.get('/admin_index', async function (req, res) {
    res.render("admin_index", { layout: false });
});
...
router.get('/electric', async function (req, res) {
    ...
    res.render("electric_list", { list: electric_models, layout: 'layout_list' });
});


// Get Add electric Cars Form Page
router.get('/addelectric', (req, res) => {
    res.render("electric_form", { layout: false });
});
...
router.get('/gas', async function (req, res) {
    ...
    res.render("gas_list", { list: gas_models, layout: 'layout_list' });
});


// Get Add Gas Cars Form Page
router.get('/addgas', (req, res) => {
    res.render("gas_form", { layout: false });
});
...
router.get('/customers', async function (req, res) {
    ...
    res.render("customers_list", { list: customers, layout: false });
});
...
router.get('/images', (req, res) => {
    res.render("images_upload", { layout: false });
});
...
router.post('/uploadimage', (req, res) => {
    upload(req, res, (err) => {
        ...
        if (err) {
            img = { err: err };
            console.log(img);
            res.render('images_upload', { img: img, layout: false });
        }
        else {
